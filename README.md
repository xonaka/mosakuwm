# mosakuwm - シンプルで使いやすいXウィンドウマネージャ
...
#### ウィンドウ操作
- **次のウィンドウに切り替え**: Alt + Ctrl + i
- **ウィンドウの移動**: Alt + 左クリック＆ドラッグ
- **ウィンドウのリサイズ**: Alt + 右クリック＆ドラッグ
...
#### モニター操作
- **次のモニターに移動**: Alt + Ctrl + n

#### 仮想スクリーン
- **仮想スクリーン1に切り替え**: Alt + F1
- **仮想スクリーン2に切り替え**: Alt + F2
- **仮想スクリーン3に切り替え**: Alt + F3
- **仮想スクリーン4に切り替え**: Alt + F4
- **ウィンドウを次の仮想スクリーンに移動**: Alt + Ctrl + d
- **ウィンドウを前の仮想スクリーンに移動**: Alt + Ctrl + a
...
#### タイル比率調整
- **メインペイン比率を増やす**: Alt + Ctrl + plus
- **メインペイン比率を減らす**: Alt + Ctrl + minus
- **メインペイン比率をリセット**: Alt + Ctrl + r
